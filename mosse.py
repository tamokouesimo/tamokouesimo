...
'''
Échantillon de suivi MOSSE

Cet exemple met en œuvre une approche de suivi basée sur la corrélation, décrite dans [1].

Usage:
   mosse.py [--pause] [<source vidéo>]

   --pause - Commence par une pause de lecture à la première image vidéo.
               Utile pour suivre la sélection de la cible.

   Dessinez des rectangles autour des objets avec une souris pour les suivre.

Clés:
   ESPACE - mettre la vidéo en pause
   c - objectifs clairs

[1] David S. Bolme et al. « Suivi visuel des objets à l'aide de filtres de corrélation adaptatifs »
